...
- **수동 기계적 락-인 (Passive Mechanical Lock-In)**: 정상 구동축(Y축 회전면)과 완전히 일치하도록 정렬된 물리적 차단 턱(Wedge-Lock) 및 미세 오버행 도피 큐브 수식을 연동 설계. 과신전 하중 발생 시 물리 구조가 즉시 강하게 잠겨 모터 전류를 끊어도 하중을 100% 지탱하며 배터리 소모를 제로(0)화합니다.
